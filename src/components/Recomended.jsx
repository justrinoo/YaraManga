		...
		<>
			<section className="container mx-auto px-16 mt-28">
				...
				<div className="border-2 border-gray-600 py-8 px-8 mt-5 rounded-md">
					<div className="flex flex-wrap flex-3 items-center">
						<div className="parent-img">
							<img src={RecomendedImage} className="h-40 mx-6 mt-2" alt="" />
							<span className="font-bold text-xl mx-6">Yin Zhi Shoumuren</span>
						</div>
						<div className="parent-img">
							<img src={RecomendedImage} className="h-40 mx-6 mt-2" alt="" />
							<span className="font-bold text-xl mx-6">Yin Zhi Shoumuren</span>
